...
public class studentlearnmore extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_studentlearnmore);
        ...
        Button edb = (Button)findViewById(R.id.learnmore);
        edb.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v)
            {
                Intent i = new Intent(v.getContext(),firstlearn.class);
                startActivity(i);
            }
